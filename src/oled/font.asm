/*
*	Module name: font.asm
*
*	Module description:
*		This module contains the font used in this project to write sentences on the SSD1306 controlled oled screen.
*		The font is called CP437 and was taken from this link: https://github.com/greiman/SSD1306Ascii
*		Thanks to Bill Greiman for sharing it.
*
*	Author: Paolo Calao
*/ 
